...
@register_criterion(
    "gwlan_info_mlm_loss", dataclass=LabelSmoothedCrossEntropyCriterionConfig
)
class GWLANInfoMlmLoss(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def get_lprobs_and_target(self, model, net_output, sample):
        ...
        target = target[ target.ne(self.task.src_dict.pad()) ]
