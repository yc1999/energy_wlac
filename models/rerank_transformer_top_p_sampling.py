...
@register_model("rerank_transformer_top_p_sampling")
class RerankTransformerTopPSamplingModel(TransformerModelBase):
    """
    ...
    def forward(
        ...
        **kwargs
        ...
        if mode == "fit":
            ...
            sorted_probs[sorted_indices_to_remove] = 1e-6
...
@register_model_architecture("rerank_transformer_top_p_sampling", "rerank_transformer_top_p_sampling")
...
@register_model_architecture("rerank_transformer_top_p_sampling", "rerank_transformer_top_p_sampling_big")
